...
class LD2402WithHR : public Component, public uart::UARTDevice {
 ...
 private:
  ...
  static const uint16_t HR_ANALYSIS_INTERVAL_MS;    // 每5秒分析一次
  ...
  float simple_heart_rate_detection();
  float simple_breath_rate_detection();
